...
public class QMUIDialog extends Dialog {
    ...
    public static class CheckBoxMessageDialogBuilder extends QMUIDialogBuilder<CheckBoxMessageDialogBuilder> {
        ...
        public CheckBoxMessageDialogBuilder(Context context ,int resAttrId) {
            super(context);
            mCheckMarkDrawable = QMUIResHelper.getAttrDrawable(context, resAttrId);
            if (mCheckMarkDrawable == null){
                mCheckMarkDrawable = context.getResources().getDrawable(resAttrId);
            }
        }
        /**
         * 设置对话框的消息文本
